...
import com.example.resmodulator.MainActivity;
import com.example.resmodulator.OrderStatus;
...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private void sendNotificationAPI26(RemoteMessage remoteMessage) {
        ...
        intent.putExtra(Common.STAFF_NO_TEXT, Common.currentTable.getTableNo());
